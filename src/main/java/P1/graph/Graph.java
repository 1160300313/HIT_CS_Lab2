...
public interface Graph<L> {
	...
	/**
	 * Add, change, or remove a weighted directed edge in this graph. If weight
	 * is nonzero, add an edge or update the weight of that edge; vertices with
	 * the given labels are added to the graph if they do not already exist. If
